...
- main-addon: addon module, custom server and client side code 
- main-ui: main application module
- main-backend: backend module, contains any server side java code and dependencies
