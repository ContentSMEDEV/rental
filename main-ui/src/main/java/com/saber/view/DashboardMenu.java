...
import com.saber.component.ProfilePreferencesWindow;
...
import com.saber.event.DashboardEvent.PostViewChangeEvent;
import com.saber.event.DashboardEvent.ProfileUpdatedEvent;
...
public class DashboardMenu extends CustomComponent {
    ...
    private Component buildTitle() {
        Label logo = new Label("EcoCar <strong>Dashboard</strong>",
                ContentMode.HTML);
    ...
    private Component buildMenuItems() {
        ...
        for (final DashboardViewType view : DashboardViewType.values()) {
            ...
            /*if (view == DashboardViewType.TRANSACTION) {
